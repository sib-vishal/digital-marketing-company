		...
		<div class="row pt-3">
			<div class="col-12 col-xl-3 col-lg-12 col-md-6 d-flex flex-column lg-mb-30px sm-mb-20px order-md-1">
				<div class="footer_logo">
					...
					<p class=" py-4 w-75 text-white">Pov Media offers comprehensive digital marketing solutions: SEO,
						SMM, design,
						development, and content.</p>
			...
			<div class="col-12 col-xl-3 col-lg-4 col-md-6  order-md-4 sm-mb-30px">
				...
				<a href="mailto:hr@povmedia.in" class="  fw-600 mt-2 d-block text-white small_heading"><i
						class="fa-solid fa-envelope"></i> hr@povmedia.in</a>
			</div>
	...
	<div class="copyRight">
		<div class="containerFull">
			<div class="copyRight_main">
				<p>Copyright © <?php echo date('Y'); ?> Pov Media. All rights reserved.</p>

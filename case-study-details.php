...
<head>
    <title>Case Study Details | Pov Media</title>
                            ...
                            <div class="row align-items-center">
                                <div class="col-lg-6">
                                    ...
                                    <p class="title">Proin eget tortor risus. Sed porttitor lectus nibh. Vivamus magna
                                        ...
                                        aliquam vel, ullamcorper sit amet ligula. cubilia Curae Curabitur aliquet quam
                                        id dui posuere blandit. Donec rutrum.
                    ...
                    <div class="case-sidebar sticky-lg-top pb-0 ">
                        <div class="inner">
                            ...
                            <ul>
                                ...
                                <li>
                                    Technologies
                                    <span>: PHP,Bootstrap </span>
                                </li>
                                <li>
                                    Website

                                    <span>: <a class="text-color1" href=">www.povmedia.in">www.povmedia.in
                                        </a></span>
            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2 aos-init aos-animate" data-aos="zoom-in-up">
                    <div class="callToAction text-center">
                        <h4 class="large_heading  font-Archivo  fontWeight800 text-white">Let’s create a measurable
                            impact on your
                            business.</h4>

                        <a href="" class="btn_1 mt-4" data-fancybox data-src="#dialog-content">Let's work
                            together <i class="fa fa-arrow-right"></i></a>
                    </div>
                </div>
            </div>
        </div>
